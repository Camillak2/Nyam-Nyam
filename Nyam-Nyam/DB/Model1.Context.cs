...
namespace Nyam_Nyam.DB
{
    ...
    public partial class NyamNyam_SagdievaEntities : DbContext
    {
        ...
        public virtual ObjectResult<GetIngredientsForSelectDish_Result> GetIngredientsForSelectDish(Nullable<int> dishId)
        {
            var dishIdParameter = dishId.HasValue ?
                new ObjectParameter("DishId", dishId) :
                new ObjectParameter("DishId", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetIngredientsForSelectDish_Result>("GetIngredientsForSelectDish", dishIdParameter);
        }
